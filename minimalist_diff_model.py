...
class DiffusionNet(nn.Module):
    def __init__(self, channels=[32,64,128,256]):
        ...
        self.upconv2 = nn.ConvTranspose2d(channels[2]+channels[2],channels[1],kernel_size=3, stride=2, bias=False)
        self.upconv3 = nn.ConvTranspose2d(channels[1]+channels[1],channels[0],kernel_size=3, stride=2, bias=False) 
