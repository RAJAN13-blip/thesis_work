...
@torch.no_grad()
def sample_IADB(D,  period, device='cuda'):
    ...
    saveImage('/home/rajan/Desktop/rajan_thesis/thesis_work/FID_score_evaluation/mnist_without_rep_learning/samples/generated_mnist_'+str(t)+'_'+str(period)+'_.png', result)
    return x_alpha
