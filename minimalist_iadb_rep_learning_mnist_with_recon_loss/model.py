...
def sample_IADB(D,VAE,  period, latent_dims=2):
    ...
    saveImage('/home/rajan/Desktop/rajan_thesis/thesis_work/minimalist_iadb_rep_learning_mnist_with_recon_loss/samples/generated_mnist_'+str(t)+'_'+str(period)+'_.png', result)
